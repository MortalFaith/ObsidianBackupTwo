...
2. 分层的作用，好处，各个层的名称
	- 分层的好处（30）：
		...
		4. 易于实现和维护
		5. 能促进标准化工作
	- 各个层的名称：![[张神版计网复习Ver. 1.5-20241031104507430.heic|500]]
...
4. **波形图（模拟、数字）**
	- 模拟和调制，主要还是（差分）曼彻斯特编码：
		- 曼彻斯特编码：位周期中心的向上跳变代表0，位周期中心的向下跳变代表1。但也可反过来定义。 （以太网采用曼彻斯特编码）
