...
**连续ARQ协议**：
	![[Clipboard 2024年10月28日 11.19.heic]]
	用n个比特编码时，发送窗口的最大值是$2^{n}-1$，接收窗口不能超过$2^{n-1}$
	![[Clipboard 2024年10月28日 11.22.heic]]

TCP是面向连接的服务

- 三次握手 首部标志位？相关字段？seq？：
	- SYN=1表示连接请求或连接接受；FIN=1表明发送完毕；ACK=1时确认号有效
	- 数据偏移（首部长度）：以四字节为单位
	-  ![[Clipboard 2024年10月28日 10.06.heic]]
- 四次挥手：如中间无数据发送，v=w
	- ![[Clipboard 2024年10月28日 10.13.heic]]
